...
public enum ErrorCode {
    ...
    USER_INFO_MISMATCH(HttpStatus.BAD_REQUEST, "AUTH_010", "입력하신 사용자 정보가 일치하지 않습니다."), // (비밀번호 찾기에서 사용 가정)
    PASSWORD_RESET_NOT_SUPPORTED_FOR_SOCIAL(HttpStatus.BAD_REQUEST, "AUTH_011", "소셜 로그인 사용자는 이 기능을 사용할 수 없습니다."), // (비밀번호 찾기에서 사용 가정)

    // Project & Member Errors (기존 코드 생략된 부분)
    ...
    CANNOT_REQUEST_FRIEND_TO_SELF(HttpStatus.BAD_REQUEST, "FRIEND_005", "자기 자신에게 친구 요청을 보낼 수 없습니다."), // INVALID_INPUT_VALUE 대신 사용 가능
