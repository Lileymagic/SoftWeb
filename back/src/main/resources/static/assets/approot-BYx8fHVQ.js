(function(){const y=document.createElement("link").relList;if(y&&y.supports&&y.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function m(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(i){if(i.ep)return;i.ep=!0;const l=m(i);fetch(i.href,l)}})();(function(){const{createElement:r,Fragment:y}=React,{createRoot:m}=ReactDOM;function a(t){t.addEventListener("click",function(e){e.target===t&&t.close()})}window.closeModal=a;function i(){let t=document.querySelector(".modal1");if(!t){const d=document.createElement("div");d.innerHTML=`<dialog class="modal1" style="overflow-y:scroll; ">
        ...
        </dialog>`,document.body.appendChild(e),t=document.querySelector(".modal3"),t?a(t):console.error("Failed to create or find .modal3 for mypage.")}return t}async function b(){const t=document.getElementById("myPageDisplayId"),e=document.getElementById("myPageNickname"),d=document.getElementById("myPageTag"),o=document.getElementById("myPageBio"),n=document.getElementById("myPageProfileImage");if(!t||!e||!d||!o||!n){console.error("MyPage modal elements not found. Ensure createMyPageModalIfNeeded ran successfully.");return}try{const u=await fetch("/api/users/me");if(!u.ok){if(u.status===401){t.textContent="로그인 필요",e.textContent="",d.textContent="",o.textContent="로그인 후 이용해주세요.";return}throw new Error(`Failed to fetch user info: ${u.status}`)}const f=await u.json(),s=f.data||f;s?(s.loginId&&s.loginId.trim()!==""?t.textContent=s.loginId:t.textContent="소셜 로그인",e.textContent=s.nickname||"닉네임 정보 없음",d.textContent=s.identificationCode?`#${s.identificationCode}`:"",o.textContent=s.bio||"자기소개가 없습니다.",n.src=s.profileImage||"/icon/user2.png"):(console.error("User info data is not in expected format:",f),t.textContent="정보 형식 오류",e.textContent="",d.textContent="")}catch(u){console.error("Error fetching user info:",u),t.textContent="정보 로드 오류",e.textContent="",d.textContent="",o.textContent="정보를 불러오는 데 실패했습니다."}}async function x(){let t=v();t?(await b(),t.showModal()):console.error("Mypage modal (.modal3) could not be initialized for showing.")}function w(){window.location.href="/front/projectlist.html"}function C(){return r("div",{className:"root"},r("button",{className:"left1 drag1 clear",onClick:w},r("img",{src:"/icon/logo.png",className:"logo",style:{height:"50px"}})),r("button",{className:"right3 drag1 clear",onClick:x,id:"mypage"},r("i",{className:"fa-solid fa-user fa-2x",style:{fontSize:"25px"}})),r("button",{className:"right2 drag1 clear",onClick:()=>{let t=document.querySelector(".modal2");t||(l(),t=document.querySelector(".modal2")),t&&t.showModal()},id:"friend"},r("i",{className:"fa-solid fa-user-group fa-2x",style:{fontSize:"25px"}})),r("button",{className:"right1 drag1 clear",onClick:()=>{let t=document.querySelector(".modal1");t||(i(),t=document.querySelector(".modal1")),t&&t.showModal()},id:"alert"},r("i",{className:"fa-solid fa-bell fa-2x",style:{fontSize:"25px"}})))}m(document.getElementById("root")).render(r(C));function g(){document.querySelector(".modal1")||i(),document.querySelector(".modal2")||l(),v()}window.addEventListener("load",g);let p=document.querySelector("#root");if(p){let t=new MutationObserver(g),e={attributes:!0,childList:!0,characterData:!0};t.observe(p,e)}document.querySelectorAll(".lenCut_container").forEach(t=>{const e=t.querySelector(".lenCut"),d=t.querySelector(".lenCutE"),o=t.querySelector(".tooltip1");if(e){const n=e.textContent;n.length>6&&(e.textContent=n.slice(0,6)+"...",o&&(e.addEventListener("mouseenter",function(){o.style.display="block",o.textContent=n}),e.addEventListener("mouseleave",function(){o.style.display="none"})))}if(d){const n=d.textContent;n.length>15&&(d.textContent=n.slice(0,15)+"...",o&&(d.addEventListener("mouseenter",function(){o.style.display="block",o.textContent=n}),d.addEventListener("mouseleave",function(){o.style.display="none"})))}}),document.querySelectorAll(".button_select").forEach(t=>{let e=!1;t.addEventListener("click",()=>{e=!e,t.classList.toggle("active"),e?t.textContent="취소":t.textContent="선택"}),t.addEventListener("mouseenter",()=>{e&&(t.textContent="취소")}),t.addEventListener("mouseleave",()=>{e&&(t.textContent="선택")})})})();
