(function(){const u=document.createElement("link").relList;if(u&&u.supports&&u.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const s of l)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function f(l){const s={};return l.integrity&&(s.integrity=l.integrity),l.referrerPolicy&&(s.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?s.credentials="include":l.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(l){if(l.ep)return;l.ep=!0;const s=f(l);fetch(l.href,s)}})();(function(){const{createElement:d,Fragment:u}=React,{createRoot:f}=ReactDOM;function r(t){t.addEventListener("click",function(e){e.target===t&&t.close()})}window.closeModal=r;function l(){let t=document.querySelector(".modal1");if(!t){const o=document.createElement("div");o.innerHTML=`
        ...
        <div>
        </dialog>`,document.body.appendChild(o),t=document.querySelector(".modal1"),t&&r(t)}const e=document.querySelector("#alertr"),i=()=>{const o=e.getBoundingClientRect(),n=t.getBoundingClientRect();t.style.position="fixed",t.style.left=`${o.right-n.width}px`,t.style.top=`${o.bottom}px`};e.addEventListener("click",()=>{t.showModal(),i()}),window.addEventListener("resize",()=>{t.open&&i()})}function s(){let t=document.querySelector(".modal2");if(!t){const i=document.createElement("div");i.innerHTML=`
          ...
          </dialog>`,document.body.appendChild(i),t=document.querySelector(".modal2"),setTimeout(()=>{c("friend1")},0),document.body.style.overflow="hidden",t&&r(t)}const e=document.querySelector("#friend");e&&e.addEventListener("click",()=>{const i=document.querySelector(".modal2");i&&(i.showModal(),setTimeout(()=>{c("friend1")},0))}),t.addEventListener("close",()=>{document.body.style.overflow="auto"})}function c(t){["friend1","friend2","friend3"].forEach(o=>{const n=document.getElementById(o);n&&(n.style.display=o===t?"block":"none")}),document.querySelectorAll(".button_friend").forEach((o,n)=>{"friend"+(n+1).toString()===t?o.classList.add("active"):o.classList.remove("active")})}window.Watchdiv=c;function x(){confirm("로그아웃 하겠습니까?")&&fetch("/api/auth/logout",{method:"POST"}).then(e=>{e.ok?window.location.href="/front/login.html?logout":alert("로그아웃에 실패했습니다. 다시 시도해주세요.")}).catch(e=>{console.error("Logout error:",e),alert("로그아웃 중 오류가 발생했습니다.")})}window.logout=x;function m(){let t=document.querySelector(".modal3");if(!t){const o=document.createElement("div");o.innerHTML=`
        <dialog class="modal3">
        <div class="middle3">
      ...
      </dialog>`,document.body.appendChild(o),t=document.querySelector(".modal3"),t?r(t):console.error("Failed to create or find .modal3 for mypage.")}const e=document.querySelector("#mypage"),i=()=>{const o=e.getBoundingClientRect(),n=t.getBoundingClientRect();t.style.position="fixed",t.style.left=`${o.right-n.width}px`,t.style.top=`${o.bottom}px`};return e.addEventListener("click",()=>{t.showModal(),i()}),window.addEventListener("resize",()=>{t.open&&i()}),t}async function v(){const t=document.getElementById("myPageDisplayId"),e=document.getElementById("myPageNickname"),i=document.getElementById("myPageTag"),o=document.getElementById("myPageBio"),n=document.getElementById("myPageProfileImage");if(!t||!e||!i||!o||!n){console.error("MyPage modal elements not found. Ensure createMyPageModalIfNeeded ran successfully.");return}try{const p=await fetch("/api/users/me");if(!p.ok){if(p.status===401){t.textContent="로그인 필요",e.textContent="",i.textContent="",o.textContent="로그인 후 이용해주세요.";return}throw new Error(`Failed to fetch user info: ${p.status}`)}const y=await p.json(),a=y.data||y;a?(a.loginId&&a.loginId.trim()!==""?t.textContent=a.loginId:t.textContent="소셜 로그인",e.textContent=a.nickname||"닉네임 정보 없음",i.textContent=a.identificationCode?`#${a.identificationCode}`:"",o.textContent=a.bio||"자기소개가 없습니다.",n.src=a.profileImage||"/icon/user2.png"):(console.error("User info data is not in expected format:",y),t.textContent="정보 형식 오류",e.textContent="",i.textContent="")}catch(p){console.error("Error fetching user info:",p),t.textContent="정보 로드 오류",e.textContent="",i.textContent="",o.textContent="정보를 불러오는 데 실패했습니다."}}async function b(){let t=m();t?(await v(),t.showModal()):console.error("Mypage modal (.modal3) could not be initialized for showing.")}function w(){window.location.href="/front/projectlist.html"}function C(){return d("div",{className:"root"},d("button",{className:"left1 drag1 clear",onClick:w},d("img",{src:"/icon/logo.png",className:"logo",style:{height:"50px"}})),d("button",{className:"right3 drag1 clear",onClick:b,id:"mypage"},d("i",{className:"fa-solid fa-user fa-2x",style:{fontSize:"25px"}})),d("button",{className:"right2 drag1 clear",onClick:()=>{let t=document.querySelector(".modal2");t||(s(),t=document.querySelector(".modal2")),t&&t.showModal()},id:"friend"},d("i",{className:"fa-solid fa-user-group fa-2x",style:{fontSize:"25px"}})),d("button",{className:"right1 drag1 clear",onClick:l,id:"alertr"},d("i",{className:"fa-solid fa-bell fa-2x",style:{fontSize:"25px"}})))}f(document.getElementById("root")).render(d(C));function g(){document.querySelector(".modal1")||l(),document.querySelector(".modal2")||s(),m()}window.addEventListener("load",g);let h=document.querySelector("#root");if(h){let t=new MutationObserver(g),e={attributes:!0,childList:!0,characterData:!0};t.observe(h,e)}document.querySelectorAll(".lenCut_container").forEach(t=>{const e=t.querySelector(".lenCut"),i=t.querySelector(".lenCutE"),o=t.querySelector(".tooltip1");if(e){const n=e.textContent;n.length>6&&(e.textContent=n.slice(0,6)+"...",o&&(e.addEventListener("mouseenter",function(){o.style.display="block",o.textContent=n}),e.addEventListener("mouseleave",function(){o.style.display="none"})))}if(i){const n=i.textContent;n.length>15&&(i.textContent=n.slice(0,15)+"...",o&&(i.addEventListener("mouseenter",function(){o.style.display="block",o.textContent=n}),i.addEventListener("mouseleave",function(){o.style.display="none"})))}}),document.querySelectorAll(".button_select").forEach(t=>{let e=!1;t.addEventListener("click",()=>{e=!e,t.classList.toggle("active"),e?t.textContent="취소":t.textContent="선택"}),t.addEventListener("mouseenter",()=>{e&&(t.textContent="취소")}),t.addEventListener("mouseleave",()=>{e&&(t.textContent="선택")})})})();
