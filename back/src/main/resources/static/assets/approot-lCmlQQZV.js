(function(){const f=document.createElement("link").relList;if(f&&f.supports&&f.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))c(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const u of l.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&c(u)}).observe(document,{childList:!0,subtree:!0});function g(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function c(s){if(s.ep)return;s.ep=!0;const l=g(s);fetch(s.href,l)}})();(function(){const{createElement:a,Fragment:f}=React,{createRoot:g}=ReactDOM;function c(e){e.addEventListener("click",function(t){t.target===e&&e.close()})}window.closeModal=c;function s(){let e=document.querySelector(".modal1");if(!e){const n=document.createElement("div");n.innerHTML=`
        <dialog class="modal1">
        ...
        <div>
          ...
          <dialog class="modal2" style="border: none; background-color: transparent;">
            ...
            `,t.appendChild(n),h(o.userIdx,o.friendStatus)}),m()}function h(e,t){const o=document.getElementById(`actionCell_${e}`);if(!o)return;o.innerHTML="";let n;switch(t){case"NONE":n=document.createElement("button"),n.className="button_select",n.style.width="80px",n.textContent="친구 신청",n.onclick=()=>T(e);break;case"PENDING_SENT":n=document.createElement("button"),n.className="button_sent",n.style.width="80px",n.textContent="요청 보냄",n.disabled=!0;break;case"PENDING_RECEIVED":o.innerHTML='<span style="font-size:small; color:orange;">요청 받음</span>';return;case"ACCEPTED":o.innerHTML='<span style="font-size:small; color:green;">친구</span>';return;case"SELF":o.innerHTML='<span style="font-size:small; color:grey;">본인</span>';return;default:o.innerHTML="-";return}n&&o.appendChild(n)}async function T(e){if(confirm("친구 요청을 보내시겠습니까?"))try{const t=await fetch("/api/friends/request",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({recipientUserId:e})}),o=await t.json();if(t.status===201)alert("친구 요청을 보냈습니다."),h(e,"PENDING_SENT");else throw new Error(o.message||"친구 요청 실패")}catch(t){console.error("Error sending friend request:",t),alert(`오류: ${t.message}`)}}async function y(){const e=document.getElementById("friendListTbody");if(e){e.innerHTML='<tr><td colspan="5" style="text-align:center; color:grey;">친구 목록 로딩 중...</td></tr>';try{const t=await fetch("/api/friends");if(!t.ok)throw new Error(`Error: ${t.status}`);const o=await t.json();if(e.innerHTML="",o.status===200&&Array.isArray(o.data)){if(o.data.length===0){e.innerHTML='<tr><td colspan="5" style="text-align:center; color:grey;">친구가 없습니다.</td></tr>';return}o.data.forEach(n=>{const r=document.createElement("tr");r.innerHTML=`
                    ...
                    `,e.appendChild(i)}),m()}else e.innerHTML=`<tr><td colspan="5" style="text-align:center; color:red;">받은 요청 목록 로드 실패: ${o.message}</td></tr>`}catch(t){console.error("Error loading received requests:",t),e.innerHTML='<tr><td colspan="5" style="text-align:center; color:red;">받은 요청 목록 로드 오류.</td></tr>'}}}async function S(e){try{const t=await fetch(`/api/friends/accept/${e}`,{method:"PATCH"}),o=await t.json();if(t.ok)alert("친구 요청을 수락했습니다."),x(),y();else throw new Error(o.message||"친구 요청 수락 실패")}catch(t){console.error("Error accepting friend request:",t),alert(`오류: ${t.message}`)}}window.acceptFriendRequestHandler=S;async function M(e){try{const t=await fetch(`/api/friends/reject/${e}`,{method:"PATCH"}),o=await t.json();if(t.ok)alert("친구 요청을 거절했습니다."),x();else throw new Error(o.message||"친구 요청 거절 실패")}catch(t){console.error("Error rejecting friend request:",t),alert(`오류: ${t.message}`)}}window.rejectFriendRequestHandler=M;function m(){document.querySelectorAll(".lenCut_container").forEach(e=>{const t=e.querySelector(".lenCut"),o=e.querySelector(".lenCutE"),n=e.querySelector(".tooltip1"),r=(i,p)=>{if(i&&n){const d=i.dataset.originalText||i.textContent;i.dataset.originalText=d,d.length>p?i.textContent=d.slice(0,p)+"...":i.textContent=d,i.onmouseenter=function(){(i.offsetWidth<i.scrollWidth||i.textContent.endsWith("..."))&&(n.style.display="block",n.textContent=d)},i.onmouseleave=function(){n.style.display="none"}}};r(t,6),r(o,15)})}window.addEventListener("load",m);function k(){confirm("로그아웃 하겠습니까?")&&fetch("/api/auth/logout",{method:"POST"}).then(t=>{t.ok?window.location.href="/front/login.html?logout":alert("로그아웃에 실패했습니다. 다시 시도해주세요.")}).catch(t=>{console.error("Logout error:",t),alert("로그아웃 중 오류가 발생했습니다.")})}window.logout=k;function b(){let e=document.querySelector(".modal3");if(!e){const n=document.createElement("div");n.innerHTML=`
        <dialog class="modal3">
        <div class="middle3">
      ...
      </dialog>`,document.body.appendChild(n),e=document.querySelector(".modal3"),e?c(e):console.error("Failed to create or find .modal3 for mypage.")}const t=document.querySelector("#mypage"),o=()=>{const n=t.getBoundingClientRect(),r=e.getBoundingClientRect();e.style.position="fixed",e.style.left=`${n.right-r.width}px`,e.style.top=`${n.bottom}px`};return t.addEventListener("click",()=>{e.showModal(),o()}),window.addEventListener("resize",()=>{e.open&&o()}),e}async function $(){const e=document.getElementById("myPageDisplayId"),t=document.getElementById("myPageNickname"),o=document.getElementById("myPageTag"),n=document.getElementById("myPageBio"),r=document.getElementById("myPageProfileImage");if(!e||!t||!o||!n||!r){console.error("MyPage modal elements not found. Ensure createMyPageModalIfNeeded ran successfully.");return}try{const i=await fetch("/api/users/me");if(!i.ok){if(i.status===401){e.textContent="로그인 필요",t.textContent="",o.textContent="",n.textContent="로그인 후 이용해주세요.";return}throw new Error(`Failed to fetch user info: ${i.status}`)}const p=await i.json(),d=p.data||p;d?(d.loginId&&d.loginId.trim()!==""?e.textContent=d.loginId:e.textContent="소셜 로그인",t.textContent=d.nickname||"닉네임 정보 없음",o.textContent=d.identificationCode?`#${d.identificationCode}`:"",n.textContent=d.bio||"자기소개가 없습니다.",r.src=d.profileImage||"/icon/user2.png"):(console.error("User info data is not in expected format:",p),e.textContent="정보 형식 오류",t.textContent="",o.textContent="")}catch(i){console.error("Error fetching user info:",i),e.textContent="정보 로드 오류",t.textContent="",o.textContent="",n.textContent="정보를 불러오는 데 실패했습니다."}}async function q(){let e=b();e?(await $(),e.showModal()):console.error("Mypage modal (.modal3) could not be initialized for showing.")}function I(){window.location.href="/front/projectlist.html"}function H(){return a("div",{className:"root"},a("button",{className:"left1 drag1 clear",onClick:I},a("img",{src:"/icon/logo.png",className:"logo",style:{height:"50px"}})),a("button",{className:"right3 drag1 clear",onClick:q,id:"mypage"},a("i",{className:"fa-solid fa-user fa-2x",style:{fontSize:"25px"}})),a("button",{className:"right2 drag1 clear",onClick:()=>{let e=document.querySelector(".modal2");e||(l(),e=document.querySelector(".modal2")),e&&e.showModal()},id:"friend"},a("i",{className:"fa-solid fa-user-group fa-2x",style:{fontSize:"25px"}})),a("button",{className:"right1 drag1 clear",onClick:s,id:"alertr"},a("i",{className:"fa-solid fa-bell fa-2x",style:{fontSize:"25px"}})))}g(document.getElementById("root")).render(a(H));function w(){document.querySelector(".modal1")||s(),document.querySelector(".modal2")||l(),b()}window.addEventListener("load",w);let C=document.querySelector("#root");if(C){let e=new MutationObserver(w),t={attributes:!0,childList:!0,characterData:!0};e.observe(C,t)}document.querySelectorAll(".lenCut_container").forEach(e=>{const t=e.querySelector(".lenCut"),o=e.querySelector(".lenCutE"),n=e.querySelector(".tooltip1");if(t){const r=t.textContent;r.length>6&&(t.textContent=r.slice(0,6)+"...",n&&(t.addEventListener("mouseenter",function(){n.style.display="block",n.textContent=r}),t.addEventListener("mouseleave",function(){n.style.display="none"})))}if(o){const r=o.textContent;r.length>15&&(o.textContent=r.slice(0,15)+"...",n&&(o.addEventListener("mouseenter",function(){n.style.display="block",n.textContent=r}),o.addEventListener("mouseleave",function(){n.style.display="none"})))}}),document.querySelectorAll(".button_select").forEach(e=>{let t=!1;e.addEventListener("click",()=>{t=!t,e.classList.toggle("active"),t?e.textContent="취소":e.textContent="선택"}),e.addEventListener("mouseenter",()=>{t&&(e.textContent="취소")}),e.addEventListener("mouseleave",()=>{t&&(e.textContent="선택")})})})();
